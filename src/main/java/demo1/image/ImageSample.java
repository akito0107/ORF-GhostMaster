...
public class ImageSample {
    ...
    public ImageSample(){
        ...
        try {
            readImage = ImageIO.read(new File("src/samples/sample.jpg"));
        } catch (Exception e) {
            e.printStackTrace();
            readImage = null;
        }
    ...
    */
    ...
    public void save(JPanel p)
    {
        ...
        p.paintAll(cg);
        try {
            if (ImageIO.write(bImg, "jpeg", new File("/Users/usa/orf2014/ORF-SIFT-Web/img/cloud.jpeg")))
            {
